...
-- Create Demographic Manga Junction Table

CREATE TABLE `demographic_manga` (
  `d_id` int NOT NULL,
  `m_id` int NOT NULL,
  PRIMARY KEY (`d_id`, `m_id`),
  CONSTRAINT `FK_DEMOGRAPHIC_DM` FOREIGN KEY (`d_id`) REFERENCES `demographic` (`d_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_MANGA_DM` FOREIGN KEY (`m_id`) REFERENCES `manga` (`m_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
