...
function Card(props: Manga) {
    ...
    return (
        <div
            className="flex border-2 border-gray-600 hover:border-gray-400 text-white m-1 p-2 font-bold bg-black bg-opacity-70 rounded-lg hover:scale-105 hover:rounded-xl transition-transform duration-300 ease-in-out"
        >
            <div>
