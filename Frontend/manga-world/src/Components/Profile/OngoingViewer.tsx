            ...
            <div>
                {ongoings.map((ongoing, index) => (
                    ...
                    >
                        ...
                        <div onClick={() => {removeItem(ongoing)}} className="bg-red-700 p-3 m-1 rounded hover:scale-105 hover:cursor-pointer hover:bg-red-900 transition-transform duration-300 ease-in-out">
                            Remove
                        </div>
                    </div>
                ))}
