        ...
        <div className="background_image_home">
            <div className={`bg-black bg-opacity-90 min-h-screen`}>
                <div className="flex justify-center pt-10 p-4 text-gray-200 text-2xl font-bold">
                    <div onClick={() => {setCurrentlySelected("Remove a user")}} className={`${currentlySelected === "Remove a user" && "bg-gray-950 border-white hover:scale-100"} bg-gray-800 border-gray-500 border-2 hover:border-white p-2 rounded-xl hover:bg-gray-950 hover:cursor-pointer transform hover:scale-110 transition-transform duration-500 ease-in-out`}>
                        Remove a user
                    </div>
                    <div onClick={() => {setCurrentlySelected("Remove a manga")}} className={`${currentlySelected === "Remove a manga" && "bg-gray-950 border-white hover:scale-100"} ms-4 bg-gray-800 border-gray-500 border-2 hover:border-white p-2 rounded-xl hover:bg-gray-950 hover:cursor-pointer transform hover:scale-110 transition-transform duration-500 ease-in-out`}>
                        Remove a manga
                    </div>
                </div>
