            ...
            {selectedCategory && (
                <div className="flex">
                    ...
                    <div className="flex-grow bg-black bg-opacity-75 min-h-screen">
                        ...
                        <div>
                            <div>
                                <Subpage fetchMangaData={MangaController.getMostViewedBasedOnCategory} fetchMangaPageNumber={MangaController.getMostViewedCountBasedOnCategory} element={selectedCategory}/>
                            </div>
