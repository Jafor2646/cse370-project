...
function PublisherViewer() {
    ...
    useEffect(() => {
        if(selectedPublisher){
            PublisherController.findPublisherPictureByPublisher(selectedPublisher).then((res) => {
    ...
    return (
        <div className="background_image_home" style={publisherPicture ? { backgroundImage: `url(${publisherPicture.ppPicture})` } : { backgroundImage: `url("./../../Assets/Images/Backgrounds/home-page-bg.jpg")` }}>
                ...
                {selectedPublisher && (
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <Subpage fetchMangaData={PublisherController.getAllPublisherManga} fetchMangaPageNumber={PublisherController.getPublisherMangaCount} element={selectedPublisher}/>
                            </div>
