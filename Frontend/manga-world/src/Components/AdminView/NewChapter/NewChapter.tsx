...
function NewChapter() {
    ...
    }, [selectedManga, selectedVolume, chapterNumber, chapterReleaseDate, chapterPageCount, pdfFile]);
    ...
    const handleChapterReleaseDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setChapterReleaseDate(e.target.value);
    };

    const handleChapterPageCountChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        const value = parseInt(e.target.value);
    ...
    return (
        <div className="w-1/3 mt-8 p-6 bg-black bg-opacity-50 rounded">
            ...
            <div className="mb-4">
                <label htmlFor="searchManga" className="block text-white text-sm font-medium">
                    Search Manga
                </label>
                <input
                    type="text"
                    ...
                    value={isSearchFocused ? searchInputValue : selectedManga?.mtitle || ''}
            ...
            <div className="mb-4">
                <label htmlFor="selectVolume" className="block text-white text-sm font-medium">
                    Select Volume
                </label>
                <select
                    id="selectVolume"
                    className="w-full p-2 border rounded"
                    onChange={(e) => handleVolumeSelect(volumeList[parseInt(e.target.value)])}
            ...
            <div className="mb-4">
                <label htmlFor="chapterNumber" className="block text-white text-sm font-medium">
                    Chapter Number
                </label>
                <input
                    type="number"
            ...
            <div className="mb-4">
                <label htmlFor="chapterReleaseDate" className="block text-white text-sm font-medium">
            ...
            <div className="mb-4">
                <label htmlFor="chapterPageCount" className="block text-white text-sm font-medium">
                    Chapter Page Count
                </label>
                <input
                    type="number"
            ...
            <div className="mb-4">
                <label htmlFor="picture" className="block text-white text-sm font-medium">
                    Picture
                </label>
                <input
                    type="file"
            ...
            <div className="mb-4">
                <label htmlFor="pdfFile" className="block text-white text-sm font-medium">
                    PDF File
                </label>
                <input
                    type="file"
            ...
            <div className="w-full">
                {pdfFile && (
                    <SmallPdfViewer pdfData={pdfFile}/>
                )}
            </div>

            <button
                className={`w-full p-2 mt-2 bg-blue-500 text-white rounded ${isSubmitDisabled && 'opacity-50 cursor-not-allowed'}`}
