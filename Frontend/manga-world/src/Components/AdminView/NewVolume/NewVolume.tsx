...
function NewVolume() {
    ...
    const handleVolumeReleaseDateChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    return (
        <div className="w-1/3 mt-8 p-6 bg-black bg-opacity-50 rounded">
            ...
            <div className="mb-4">
                <label htmlFor="volumeNumber" className="block text-white text-sm font-medium">
                    Volume Number
                </label>
                <input
                    type="number"
            ...
            <div className="mb-4">
                <label htmlFor="volumeTitle" className="block text-white text-sm font-medium">
                    Volume Title
                </label>
                <input
                    type="text"
            ...
            <div className="mb-4">
                <label htmlFor="volumeReleaseDate" className="block text-white text-sm font-medium">
                    Volume Release Date
                </label>
                <input
                    type="date"
