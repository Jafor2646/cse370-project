...
class MangaController {
    ...
    getBasedOnLastSearch(userId: string){
        return axios.get(USER_API_BASE_URL + "mangas/getBasedOnLastSearch" + "/" + userId);
    }

    getMostViewedBasedOnCategory(pageNumber: number, category: any){
        return axios.post(USER_API_BASE_URL + "mangas/getMostViewedBasedOnCategory" + "/" + pageNumber, category);
    }

    getMostViewedCountBasedOnCategory(category: any){
        return axios.post(USER_API_BASE_URL + "mangas/getMostViewedCountBasedOnCategory" , category);
    }
