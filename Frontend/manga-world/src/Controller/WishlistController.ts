...
class WishlistController {
    ...
    getAllOngoing(userId: any, pageNumber: number){
        return axios.get(USER_API_BASE_URL + "getAllOngoing/" + userId + "/" + pageNumber);
    }

    getAllAlreadyRead(userId: any, pageNumber: number){
        return axios.get(USER_API_BASE_URL + "getAllAlreadyRead/" + userId + "/" + pageNumber);
    }

    getAllWishlist(userId: any, pageNumber: number){
        return axios.get(USER_API_BASE_URL + "getAllWishlist/" + userId + "/" + pageNumber);
    }
